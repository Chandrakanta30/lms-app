            ...
            <div class="row g-0">
                <div class="col-lg-7 login-brand-side">
                    <div class="brand-pill">
                        <img src="{{ asset('assets/images/sms-logo.jpg') }}" alt="SMS Pharmaceuticals">
                        SMS Pharmaceuticals
                    </div>
                    ...
                    <p class="hero-copy">
                        A modern learning workspace for regulated teams, combining role-based delivery, qualification
                        tracking, session logging, and assessment workflows in one secure place.
                    </p>
                ...
                <div class="col-lg-5 login-form-side">
                    <div class="login-form-card">
                        <div class="mb-4">
                            <div class="login-helper text-uppercase mb-2"
                                style="font-size: 0.74rem; letter-spacing: 0.16em;">Welcome back</div>
                            <h3 class="text-white font-weight-bold mb-2">Sign in to continue</h3>
                            <p class="login-helper mb-0">Access your training dashboard, assignments, records, and exam
                                workflows.</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login.post') }}">
                            ...
                            <div class="form-group">
                                <label class="login-label">Employee ID</label>
                                <div class="login-input-wrap">
                                    <i class="mdi mdi-account-outline"></i>
                                    <input type="text" name="corporate_id"
                                        class="login-control @error('corporate_id') is-invalid @enderror"
                                        placeholder="Enter your employee ID" value="{{ old('corporate_id') }}" required
                                        autofocus>
                                </div>
                                @error('corporate_id')
                            ...
                            <div class="form-group">
                                ...
                                <div class="login-input-wrap">
                                    ...
                                    <input type="password" name="password" class="login-control"
