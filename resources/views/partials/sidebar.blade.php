...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
    <a class="app-brand" href="{{ route('dashboard') }}">
        ...
        <span class="brand-copy ms-2">
            ...
            <span class="text-uppercase text-muted" style="font-size: 0.68rem; letter-spacing: 0.14em;">Training Hub</span>
        </span>
    </a>
  ...
  <div class="px-4 py-3 sidebar-search-wrapper">
    <div class="input-group input-group-merge">
      ...
      <input type="text" id="sidebarFilter" class="form-control" placeholder="Filter navigation...">
    </div>
  </div>
  ...
  <ul class="menu-inner py-1" id="sidebar">
    ...
    <li class="menu-item {{ request()->routeIs('dashboard') ? 'active' : '' }}" data-nav-item="true" data-nav-text="Dashboard Overview">
    ...
    @canany(['user-create', 'user-list', 'trainer-list'])
      ...
      <li class="menu-item {{ (str_contains($currentRoute, 'users') || str_contains($currentRoute, 'trainers')) ? 'active open' : '' }}" data-nav-item="true" data-nav-text="Users Trainers List">
    ...
    @canany(['role-list', 'permission-list'])
      ...
      @can('role-list')
        <li class="menu-item {{ str_contains($currentRoute, 'roles') ? 'active' : '' }}" data-nav-item="true" data-nav-text="Roles Access">
      ...
      @can('permission-list')
        <li class="menu-item {{ str_contains($currentRoute, 'permissions') ? 'active' : '' }}" data-nav-item="true" data-nav-text="Permissions Access">
    ...
    @canany(['master-list', 'training-list', 'session-list'])
      <li class="menu-header small text-uppercase" data-nav-item="true" data-nav-text="Training Masters Setup Calendar Register">
        <span class="menu-header-text">Training</span>
      </li>

      @can('master-list')
        <li class="menu-item {{ str_contains($currentRoute, 'masters') && !str_contains($currentRoute, 'trainers') ? 'active' : '' }}" data-nav-item="true" data-nav-text="Masters Setup Department Designation Venue Section">
      ...
      @can('training-list')
        <li class="menu-item {{ (request()->routeIs('trainings.index') || request()->routeIs('created-training-setup') || request()->routeIs('annual-training') || request()->routeIs('created-annual-training') || request()->routeIs('training-list') || request()->routeIs('training-calendar')) ? 'active open' : '' }}" data-nav-item="true" data-nav-text="Training Setup Created Annual Plan Calendar List">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
      ...
      @can('session-list')
        <li class="menu-item {{ request()->routeIs('sessions.index') ? 'active' : '' }}" data-nav-item="true" data-nav-text="Training Register Logs Session Approval">
    ...
    {{-- ASSESSMENT SECTION --}}
    <li class="menu-header small text-uppercase" data-nav-item="true" data-nav-text="Assessment Exams Schedule History Logs">
      <span class="menu-header-text">Assessment</span>
    </li>

    <li class="menu-item {{ (request()->routeIs('exam.list') || request()->routeIs('exams.history') || request()->routeIs('admin.exams.logs')) ? 'active open' : '' }}" data-nav-item="true" data-nav-text="Training Schedule List Results History Admin Logs">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
    ...
    {{-- DOCUMENTS --}}
    @can('documents')
      <li class="menu-item {{ str_contains($currentRoute, 'master-documents') ? 'active' : '' }}" data-nav-item="true" data-nav-text="Documents File Vault Controlled Documents">
    ...
    {{-- EXAM WORKSPACE --}}
    @can('view-exam-list')
      <li class="menu-item {{ request()->routeIs('exam.list') ? 'active' : '' }}" data-nav-item="true" data-nav-text="Exam Workspace Take Exam">
        <a href="{{ route('exam.list') }}" class="menu-link">
    ...
    @can('induction-training')
      <li class="menu-item {{ request()->routeIs('user.training.index') ? 'active' : '' }}" data-nav-item="true" data-nav-text="Induction Training Progress Trainee Setup">
