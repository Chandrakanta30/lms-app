...
@php
    ...
    $isChildView = isset($parentPlan);
    $isCreatedRoute = request()->routeIs('created-annual-training*');
@endphp
                                                ...
                                                <div class="list-group list-group-flush">
                                                    @foreach ($training->steps as $step)
                                                        <div
                                                            ...
                                                            <div><b class="text-primary mr-2">{{ $loop->iteration }}</b>
                                                                {{ $step->name }}</div>
                                                            <span
