        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-lg-4 mb-3">
                        <div class="border rounded p-3 h-100 bg-light">
                            <h6 class="mb-2">Signature of the Trainer</h6>
                            ...
                            @if ($attendanceSignedAt)
                                <div class="small mt-2">
                                    {{ \Illuminate\Support\Carbon::parse($attendanceSignedAt)->format('d M Y, h:i A') }}
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <form id="attendanceForm" method="POST"
                    action="{{ route('attendance.submit', ['id' => $module->id, 'page' => request('page')]) }}">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sessionDuration" class="form-control bg-light"
                            ...
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    ...
                                    <textarea name="session_comments" class="form-control" rows="2"
                                        placeholder="Add trainer comments or what was covered in the classroom session."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                @forelse($users as $user)
                                    ...
                                    <tr data-user-id="{{ $user->id }}">
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="attendance[{{ $user->id }}]"
                                                value="{{ $isPresent ? '1' : '0' }}" class="attendance-input">
                                            <button type="button"
                                        ...
                                        <td>
                                            <span
                                                class="badge status-badge {{ $isPresent ? 'badge-success' : 'badge-danger' }}">
