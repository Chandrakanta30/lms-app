...
<div class="content-wrapper">
                ...
                <div class="form-group">
                    ...
                    <div id="step-container">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" name="step_names[]" class="form-control" placeholder="Administration & Maintenance" required>
                        </div>
                    </div>
    ...
    <select name="training_type" id="training_type" class="form-control">
        <option value="classroom">Classroom / Instructor Led</option>
        <option value="self_training">Self Training (E-Learning)</option>
    </select>
</div>
...
<div class="row">
    ...
    <script>
        ...
        document.getElementById('self_training_section').style.display = 
            (this.value === 'self_training') ? 'block' : 'none';
    });
