@extends('partials.app') @section('content')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 300px">
                            @if($m['name'] == 'Induction Training') @php
                            $stepCount = count($m['steps']); $width = $stepCount
                            > 0 ? (100 / $stepCount) . '%' : '100%'; @endphp
                            ...
                            <div
                                ...
                                "
                            >
                                @foreach($m['steps'] as $step) @php $modalId =
                                'stepModal_'.$user->id.'_'.$step['id']; @endphp
...
@foreach($trainees as $user) @foreach($user->assigned_progress as $m)
@if($m['name'] == 'Induction Training') @foreach($m['steps'] as $step) @php
$modalId = 'stepModal_'.$user->id.'_'.$step['id']; @endphp
