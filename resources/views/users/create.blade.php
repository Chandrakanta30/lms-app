            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Organize identity, access, and profile details in a shorter,
                            easier-to-scan layout.</p>
                    </div>
                ...
                <form action="{{ isset($user) ? route('users.update', $user->id) : route('users.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="roles[]" class="form-control js-example-basic-multiple" multiple="multiple"
                                    style="width:100%">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="job_description" class="form-control" rows="3" placeholder="Enter job description...">{{ old('job_description', $user->job_description ?? '') }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="mt-4">
                        <button type="submit"
                            class="btn btn-success mr-2">{{ isset($user) ? 'Update User' : 'Create User' }}</button>
